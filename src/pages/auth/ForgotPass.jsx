  ...
  return (
    <div className={`grid place-items-center h-screen ${color.bg} `}>
      <div className="text-center px-4 ">
        <h2
          className={` flex items-center gap-2 font-ubuntu font-bold text-3xl justify-center ${color.brand}`}
        >
          <RiMicrosoftLoopFill />
          <span>FriendLoop</span>
        </h2>
        <h3 className={` ${color.txt} font-medium mt-5 font-opensans`}>
          Forgot your password? <br /> Oops! It happens, no need to worry!{" "}
          <br /> Let's get you back in!{" "}
        </h3>
        ...
        <form className={`p-2 mt-10 `}>
          <div className="flex flex-col gap-5">
            ...
            <Button
              type={"button"}
              text={"Send OTP"}
              style={"w-full py-2 font-ubuntu font-semibold  "}
              icon={<RiMailSendLine className="text-xl" />}
            />
          </div>
        </form>
