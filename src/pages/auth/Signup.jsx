  ...
  return (
    <div className={`grid place-items-center h-screen ${color.bg} `}>
        <div className="text-center px-4 ">
                ...
                <h3 className={` ${color.txt} font-medium mt-5 font-opensans`}>Chase your dreams, we're here every step of the way.<br/> Lets create your <span className={`font-ubuntu font-medium ${color.brand} `}>FriendLoop</span> account now. </h3>
                ...
                <form  className={`p-2 mt-10 `}>
                  <div className="flex flex-col gap-8">
                    ...
                    <div className="">
                      ...
                      <Button type={"button"} text={"Sign up"} style={"w-full mt-1 py-2 font-ubuntu font-semibold  "} icon={<FaRegAddressBook/>} />
                      <p className={`font-ubuntu text-sm mt-1 ${color.txt}  ` }>If you have an account already , Please <Link to="/login" className={`font-semibold ${color.brand} `}>Login</Link> </p>
                    </div>
                  </div>
                </form>
        </div>
